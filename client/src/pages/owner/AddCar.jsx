    ...
    <div className='px-4 py-10 md:pxx-10 flex-1'>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid gird-cols-1 md:grid-cols-2 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type="text" placeholder='add model' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.model} onChange={e=> setCar({...car, model: e.target.value})}/>
          </div>
